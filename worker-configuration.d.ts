/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5164f30f006778c0817f45216fe5e8fd)
...
interface __BaseEnv_Env {
	...
	AUDIENCE: "fleet";
	COOKIE_DOMAIN: ".ethanchung.dev";
	ACCESS_TTL_SEC: "3600";
	REFRESH_TTL_SEC: "2592000";
	REDIRECT_ALLOWLIST: "[\"https://ccusage.ethanchung.dev\"]";
	GITHUB_REDIRECT_URI: "https://auth.ethanchung.dev/callback";
	GITHUB_CLIENT_ID: "Ov23liPyz25gwtayKH7R";
	REFRESH_FAMILY: DurableObjectNamespace<import("./src/index").RefreshFamily>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RefreshFamily";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ISSUER" | "AUDIENCE" | "COOKIE_DOMAIN" | "ACCESS_TTL_SEC" | "REFRESH_TTL_SEC" | "REDIRECT_ALLOWLIST" | "GITHUB_REDIRECT_URI" | "GITHUB_CLIENT_ID">> {}
}
